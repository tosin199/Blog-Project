...
router.post('/',passport.authenticate("jwt",{session:false}), controller.createSubs);
router.post('/addCategory',passport.authenticate('jwt',{session:false}),controller.createCategorySub);
